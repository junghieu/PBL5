...
# Đổi tên để tương thích với code phía dưới
preprocess_image = preprocess_base
export_word = build_docx_mem
...
async def lifespan(app: FastAPI):
    ...
    # print("[INIT] TẠM THỜI VÔ HIỆU HÓA TẤT CẢ MODEL")

    job_queue = asyncio.Queue()
    asyncio.create_task(ai_worker()) # ĐÃ KÍCH HOẠT LẠI
    # print("[INIT] TẠM THỜI VÔ HIỆU HÓA AI WORKER")
